...
%%%%save x/media/gonond/LaCieG/data-navioc/res_sel_not_normalized.mat
...
function [features_pt, features_dyn] = definefeaturesnormalized()

	features_dyn = {... 
		struct('expec', 0.2501, 'type', 'acc2sum', 'type_c', false, 'type_w', false, 'type_other', false, 'w0', -1) ...
	};
	features_pt = {... 
		struct('expec', 0.0914, 'type', 'iesum', 'a', 25, 'R', 0.4, 'skip_wp', false, 'skip_wc', false, 'skip_other', false) ...
		struct('expec', 0.0399, 'type', 'dgaussiansum', 'sigma', 0.5, 'skip_wp', false, 'skip_wc', false, 'skip_other', false) ...
		struct('expec', 0.0298, 'type', 'dvgaussiansum', 'sigma_p', 0.5, 'sigma_v', 0.5, 'skip_wp', false, 'skip_wc', false, 'skip_other', false) ...
		...struct('expec', 0.8874, 'type', 'dinv2sum', 'skip_wp', false, 'skip_wc', false, 'skip_other', false) ...
		struct('expec', 0.0472, 'type', 'verr2sum', 'type_c', false, 'type_w', false, 'type_other', false) ...
	};
end
