...
features_pt = {... state-dependent features
    ...
    struct('type', 'omegagaussiansum', 'mu', -0.3, 'sigma', 0.3) ...
    struct('type', 'omegagaussiansum', 'mu', 0.3, 'sigma', 0.3) ...
    ...	'feature', struct('type', 'omega2sum')) ...
    ...struct('type', 'activ', 'a', -5, 'c', 0, ...
    ...	'feature', struct('type', 'omega2sum'))...
    ...struct('type', 'activ', 'a', -5, 'c', 0, ...
    ...	'feature', struct('type', 'xerr2sum', 'order', 2))...
    ...struct('type', 'xerr2sum', 'order', 2) ...
    ...struct('type', 'aleft2sum') ...
    ...struct('type', 'along2sum') ...
    ...struct('type', 'omega2sum') ...
    ...struct('type', 'square', 'feature', struct('type', 'omega2sum'), 'w0', 100.0) ...
    ...struct('type', 'square', 'feature', struct('type', 'aleft2sum'), 'w0', 1.0) ...
    ...struct('type', 'square', 'feature', struct('type', 'along2sum'), 'w0', 1.0) ...
    ...struct('type', 'xerr4sum', 'order', 1, 'w0', 1.0) ...
    ...struct('type', 'xerr4sum', 'order', 2, 'w0', 1.0) ...
    ...struct('type', 'aleft4sum') ...
    ...struct('type', 'along4sum') ...
};

sample = pairforged(1e-5, 0, 2.5);
addpath Visualization

playsample(sample, mdp_data_arr{1}, true);
