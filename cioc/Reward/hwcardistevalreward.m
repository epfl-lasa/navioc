% Highway car parallel distance feature.
function [r,g,drdu,d2rdudu,drdx,d2rdxdx,gfull,Hfull] = ...
    hwcardistevalreward(reward,mdp_data,x,u,states,A,B,dxdu,d2xdudu)
...
if nargout > 1,
    [~,r2,~,dr2dx] = highwaycareval(states,reward);
else
    [~,r2] = highwaycareval(states,reward);
end;
